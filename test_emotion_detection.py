...
class TestEmotionDetection(unittest.TestCase):
    ...
    def test_joy(self):
        self.assertEqual(emotion_detector("I am so glad this happened")["dominant_emotion"], "joy")
    ...
    def test_sadness(self):
        self.assertEqual(emotion_detector("I am so sad about that")["dominant_emotion"], "sadness")
